...
public class hrApiWithJsonPath {
    ...
    public void test1(){
        ...
        //get all country names where their region id is equla to 2
        ...
        //gPAth olduğu için hem json da hemde response ta çalışıyor bu path
        List<String > countryNamesWithRegionID22= response.path("items.findAll {it.region_id==3}.country_name");
        System.out.println(countryNamesWithRegionID22);
